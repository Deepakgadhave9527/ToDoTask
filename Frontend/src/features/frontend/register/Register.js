...
const Register = ({ addUserName }) => {
    ...
    const validate = () => {
        if (user.username == "" && user.mobile == "" && user.email == "" && user.password == "") {
    ...
    const err = () => {
        ...
        if (/^[0]?[6789]\d{9}$/.test(user.mobile) === false) {
            setValidation("Mobile numbers is not correct.");
            setTimeout(() => {
                setValidation("");
            }, 4000);
            return false;
    ...
    const onHandleSubmit = (e) => {
        ...
        if (validate() == true) {
            if (err() == true) {
                API.post("http://127.0.0.1:3003/api/auth/post", user).then((res) => {
        ...
        <Card className={classes.root}>
            ...
            <Container component="main" maxWidth="xs">
                ...
                <div className={classes.paper}>
                    ...
                    <form className={classes.form} noValidate exact="true" onSubmit={onHandleSubmit} >
                        <Grid container spacing={2}>
                            <Grid item xs={12} >
                                ...
                                {(validationError === "Name is required." || validationError === "No special characters are allowed.") ? (<span className={classes.register_error}>{validationError}</span>) : <></>}
                            ...
                            <Grid item xs={12}>
                                ...
                                {(validationError === "Mobile is Required." || validationError === "Mobile numbers is not correct.") ? <span className={classes.register_error}>{validationError}</span> : <></>}
                            ...
                            <Grid item xs={12}>
                                ...
                                {(validationError === "Email is Required." || validationError === ("Email address is not correct.")) ? (<span className={classes.register_error}>{validationError}</span>) : <></>}
                                <TextField
                            ...
                            <Grid item xs={12}>
                                ...
                                {validationError == "Password is Required." ? <span className={classes.register_error}>{validationError}</span> : <></>}
                                <TextField
                                    value={user.password}
